...
namespace Rawler.Core
{
   ...
   //         RawlerLib.ObjectLib.FildCopy(this as T, clone);
        ...
        /// <returns></returns>
        public RawlerBase AddRange(params Rawler.Core.RawlerBase[] children)
        {
        ...
        public virtual string ToObjectString()
        {
            ...
            System.Reflection.PropertyInfo[] properties = type.GetRuntimeProperties().ToArray();
            for (int i = 0; i < properties.Length; i++)
            {
                ...
                {
                    System.Reflection.ParameterInfo[] param = properties[i].GetMethod.GetParameters();
        ...
        {
            if (xaml == null) xaml = XamlServices.Save(this);
            return xaml;
        }
