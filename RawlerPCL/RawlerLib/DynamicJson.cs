...
namespace Codeplex.Data
{
    public class DynamicJson : DynamicObject
    {
        ...
        /// <returns></returns>
        public bool TryGetMember(string TargetName, out object result)
        {
            return (IsArray)
    ? TryGet(xml.Elements().ElementAtOrDefault(int.Parse(TargetName)), out result)
    : TryGet(xml.Element(TargetName), out result);
        }
    }
}