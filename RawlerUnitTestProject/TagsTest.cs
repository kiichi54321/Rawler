...
namespace RawlerUnitTestProject
{
    ...
    public class TagAnalyze
    {
        ...
        public static IEnumerable<TagClass> GetTag(string txt, string tag)
        {
            ...
            //            string startTag = "<" + tag + " " ;
            string endTag = "</" + tag + ">";
            Rawler.Tool.StopWatch.WriteConsole("start1");
            var startList = StringIndexList(txt, new string[] { "<" + tag + " ", "<" + tag + ">" });
            Rawler.Tool.StopWatch.WriteConsole("start2");
            var endList = StringIndexList(txt, endTag);
            Rawler.Tool.StopWatch.WriteConsole("start3");
            Dictionary<int, TagClass> dic = new Dictionary<int, TagClass>();
            Rawler.Tool.StopWatch.WriteConsole("start4");
            var t = txt.ToArray();
            ...
            Rawler.Tool.StopWatch.WriteConsole("start7");
